      ...
      <div>
        <p className="text-sm text-gray-700">
          ...
          <span className="font-medium">
            {" "}
            {data.length === 0 ? 0 : currentPage * postsPerPage - 2}{" "}
          </span>
          to
          <span className="font-medium">
            {" "}
      ...
      <div>
        ...
        >
          <button
            ...
            className={`${
              currentPage <= 1
                ? "disabled: opacity-50 relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500"
