  ...
  return (
    <>
      <div className="border-2 border-black p-5">
        <form className="flex flex-col justify-center space-y-10 lg:space-y-0 lg:flex-row lg:space-x-10" onSubmit={onSubmit}>
          ...
          <select className="m-0 w-full border-b-2 border-gray-300 onFocus: outline-none" onChange={onCompanyFilter}>
