  ...
  return (
    <>
      <div className="border-2 border-black">
        <form
          className="flex flex-col space-y-10 items-center px-5 lg:px-16 py-5 lg:py-40"
          onSubmit={onSubmit}
        >
          <input
            type="text"
            ...
            name="title"
            className="w-full border-b-2 border-gray-300 onFocus: outline-none placeholder-black"
            onChange={onDescFilter}
          />
          <select
            className="w-full border-b-2 border-gray-300 onFocus: outline-none"
